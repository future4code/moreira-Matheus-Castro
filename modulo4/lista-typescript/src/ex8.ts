const dataAniversario :string = '05/02/1998'
const dataCarteira :string = '14/04/2016'

function renovar(niver:string, emissao:string): boolean{
...
console.log(renovar(dataAniversario,dataCarteira))